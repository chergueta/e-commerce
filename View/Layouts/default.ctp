    		...
    		<!-- Container Starts -->
    			...
    			<!-- Payment Gateway Links Starts -->
    				<ul class="pull-right list-inline">
    					<li>
    						<img src="<?php echo $this->webroot;?>images/payment-icon/cirrus.png" alt="PaymentGateway" />
    					</li>
    					<li>
    						<img src="<?php echo $this->webroot;?>images/payment-icon/paypal.png" alt="PaymentGateway" />
    					</li>
    					<li>
    						<img src="<?php echo $this->webroot;?>images/payment-icon/visa.png" alt="PaymentGateway" />
    					</li>
    					<li>
    						<img src="<?php echo $this->webroot;?>images/payment-icon/mastercard.png" alt="PaymentGateway" />
    					</li>
    					<li>
    						<img src="<?php echo $this->webroot;?>images/payment-icon/americanexpress.png" alt="PaymentGateway" />
    					</li>
    				</ul>
